...
const About = () => {
    ...
    return (
        <div className="mainDivAbout">
            <Navbar />
            <h1 className='TextAboutMe'>About Me:</h1>
